...
def text_to_audio():
    apikey = 'zWZg0_uQmpDimcc8O29k1uLIJqbYFjgtnv4Zrrve5FUM'
    url = 'https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/e1d5962b-3033-4a60-9f2d-1c41f65a3876'
    ...
    with open('./texttoaudio.mp3', 'wb') as audio_file:
        res = tts.synthesize(text, accept='audio/mp3', voice='en-US_AllisonV3Voice').get_result()
        audio_file.write(res.content)


def play_audio():
    playsound('texttoaudio.mp3')
